...
<head>
  ...
  #tablaAnteproyectos tbody tr:nth-child(even) {
    background-color: rgba(193, 214, 49, 0.1) !important;
  }
  
  #tablaAnteproyectos tbody tr:hover {
...
<body>
    ...
    <section class="hero text-center">
        <div class="container hero-content">
            ...
            <h1>Historial de Mis Anteproyectos</h1>
            <p>Usuario: <c:out value="${nombres}" /></p>
            <a href="#crud" class="btn-exercise">
                <i class="fas fa-arrow-down me-2"></i>Ver Versiones
            </a>
        </div>
    </section>
    
    <section id="crud">
                <h3 class="section-title">Mi Historial de versiones</h3>
