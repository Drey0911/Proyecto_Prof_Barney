...
<c:if test="${pageContext.request.method eq 'POST' and not fn:contains(pageContext.request.contentType, 'multipart/form-data')}">
    ...
    <c:if test="${accion eq 'calificar'}">
        ...
        <c:choose>
            ...
            <c:when test="${empty anteRec.rows[0].estado_calificacion_director}">
                <sql:update dataSource="${trabajosdegradoBD}">
                    UPDATE anteproyecto 
                    SET estado_calificacion_director = ?
                    WHERE id = ?
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="../vistas/principal.jsp?id=${idDirector}&rol=${rol}&nombre_rol=${nombreRol}&nombres=${nombres}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../vistas/principal.jsp?id=${idDirector}&rol=${rol}&nombre_rol=${nombreRol}&nombres=${nombres}#about">
